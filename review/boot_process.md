...
- [BIOS](#bios)
  ...
  - [How BIOS Finds the Bootloader (MBR)](#how-bios-finds-the-bootloader-mbr)
...
- [Kernel](#kernel)
  ...
  - [Kernel Initialization and the Initramfs](#kernel-initialization-and-the-initramfs)
  - [Mounting the Boot Root Filesystem](#mounting-the-boot-root-filesystem)
